              ...
              <div className="grid grid-cols-5 sm:grid-cols-8 md:grid-cols-10 lg:grid-cols-12 gap-2">
                {episodes.map((ep, idx) => (
                  <a 
                    ...
                    className="flex flex-col items-center justify-center p-2 bg-zinc-900/50 border border-zinc-800/50 rounded-md hover:bg-red-600 hover:border-red-500 group transition-all aspect-square"
                  >
                    <span className="text-zinc-600 group-hover:text-red-200 text-[8px] mb-0.5 uppercase tracking-tighter font-black">EP</span>
                    <span className="text-white font-black text-sm group-hover:scale-110 transition-transform">{ep.chapterName}</span>
                  </a>
                ))}
              </div>
            </div>
